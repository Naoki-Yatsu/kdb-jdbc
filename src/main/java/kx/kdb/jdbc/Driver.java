...
public class Driver implements java.sql.Driver {
    ...
    public Connection connect(String s, Properties p) throws SQLException {
        return !acceptsURL(s) ? null
                : new co(s.substring(7), p != null ? p.get("user") : p, p != null ? p.get("password") : p);
    }
    ...
    public class co implements Connection {
        ...
        public co(String s, Object u, Object p) throws SQLException {
            int i = s.indexOf(":");
            try {
                c = new c(s.substring(0, i), Integer.parseInt(s.substring(i + 1)),
                        u == null ? "" : (String) u + ":" + (String) p);
            } catch (Exception e) {
                q(e);
            }
        }
    ...
    public class dm implements DatabaseMetaData {
        ...
        public ResultSet getTables(String a, String b, String t, String x[]) throws SQLException {
            return co.qx("raze{([]TABLE_CAT:`;TABLE_SCHEM:`;TABLE_NAME:system string`a`b x=`VIEW;TABLE_TYPE:x)}each",
                    x);
        }
        ...
        public ResultSet getPrimaryKeys(String a, String b, String t) throws SQLException {
            q("pk");
            return co.qx("");
        } // "q)([]TABLE_CAT:'',TABLE_SCHEM:'',TABLE_NAME:'"+t+"',COLUMN_NAME:key
          // "+t+",KEY_SEQ:1+asc count key "+t+",PK_NAME:'')");}

        public ResultSet getImportedKeys(String a, String b, String t) throws SQLException {
            q("imp");
            return co.qx("");
        } // "q)select
          // PKTABLE_CAT:'',PKTABLE_SCHEM:'',PKTABLE_NAME:x,PKCOLUMN_NAME:first
          // each key each
          // x,FKTABLE_CAT:'',FKTABLE_SCHEM:'',FKTABLE_NAME:'"+t+"',FKCOLUMN_NAME:y,KEY_SEQ:1,UPDATE_RULE:1,DELETE_RULE:0,FK_NAME:'',PK_NAME:'',DEFERRABILITY:0
          // from('x','y')vars fkey "+t);}
        ...
        public ResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
                String columnNamePattern) throws SQLFeatureNotSupportedException {
            throw new SQLFeatureNotSupportedException("nyi");
        }
    }
...
/*
 * class ar implements Array{ public String getBaseTypeName()throws SQLException{q();return null;} public int getBaseType()throws SQLException{q();return 0;} public Object getArray()throws
 * SQLException{q();return null;} public Object getArray(Map map)throws SQLException{q();return null;} public Object getArray(long index,int count)throws SQLException{q();return null;} public Object
 * getArray(long index,int count,Map map)throws SQLException{q();return null;} public ResultSet getResultSet()throws SQLException{q();return null;} public ResultSet getResultSet(Map map)throws
 * SQLException{q();return null;} public ResultSet getResultSet(long index,int count)throws SQLException{q();return null;} public ResultSet getResultSet(long index,int count,Map map)throws
 * SQLException{q();return null;}} class bl implements Blob{ public long length()throws SQLException{q();return 0L;} public byte[]getBytes(long pos,int length)throws SQLException{q();return null;}
 * public InputStream getBinaryStream()throws SQLException{q();return null;} public long position(byte[]pattern,long start)throws SQLException{q();return 0L;} public long position(Blob pattern,long
 * start)throws SQLException{q();return 0L;}} class cl implements Clob{ public long length()throws SQLException{q();return 0L;} public String getSubString(long pos,int length)throws
 * SQLException{q();return null;} public Reader getCharacterStream()throws SQLException{q();return null;} public InputStream getAsciiStream()throws SQLException{q();return null;} public long
 * position(String searchstr,long start)throws SQLException{q();return 0L;} public long position(Clob searchstr,long start)throws SQLException{q();return 0L;}} class re implements Ref{public String
 * getBaseTypeName()throws SQLException{q();return null;}} // DriverPropertyInfo a=new DriverPropertyInfo("user",null),b=new DriverPropertyInfo("password",null),r[]=new DriverPropertyInfo[2]; //
 * a.required=b.required=false;r[0]=a;r[1]=b;for(int i=0;i<r.length;i++)r[i].value = p.getProperty(r[i].name);return r;} public ResultSet getBestRowIdentifier(String a,String b,String t,int
 * scope,boolean nullable)throws SQLException {return co.qx("select SCOPE:'1',COLUMN_NAME:name,DATA_TYPE:([x:('int','float','varchar','date',' time','timestamp','varbinary')]
